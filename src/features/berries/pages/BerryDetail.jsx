...
/**
 * BerryDetailSkeleton Component
 * Displays loading placeholder for berry detail view
 */
...
/**
 * BerryDetail Component
 * Displays detailed information about a specific Pokémon berry
 */
      ...
      <div className="bg-emerald-600 dark:bg-emerald-900 relative text-white h-[200px] flex items-center justify-center transition-colors duration-500 rounded-t-3xl">
        <div className="absolute top-0 left-0 w-full p-6 flex justify-between items-start z-20">
          ...
          <span className="text-xs font-bold opacity-90 uppercase px-3 py-1 bg-white/20 rounded-full tracking-wider shadow-sm flex items-center gap-1.5">
            <img
              src="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/miracle-seed.png"
              alt="Seed"
      ...
      <div className="pt-20 px-8 pb-8">
        ...
        <div className="flex justify-between gap-4 mb-8">
          <div className="flex-1 bg-gray-50 dark:bg-gray-700/50 p-4 rounded-2xl text-center border border-gray-100 dark:border-gray-600 hover:shadow-md transition-all">
            <img
              src="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/wailmer-pail.png"
              alt="Growth"
          ...
          <div className="flex-1 bg-gray-50 dark:bg-gray-700/50 p-4 rounded-2xl text-center border border-gray-100 dark:border-gray-600 hover:shadow-md transition-all">
            <img
              src="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/big-root.png"
              alt="Size"
              className="w-8 h-8 mx-auto mb-1 object-contain"
            />
            <p className="text-[10px] sm:text-xs text-gray-500 dark:text-gray-400 font-bold uppercase">Size</p>
            <p className="text-lg sm:text-xl font-black text-gray-800 dark:text-gray-100">
              {berry.size} <span className="text-sm font-medium text-gray-500 dark:text-gray-400">mm</span>
            </p>
          </div>
          <div className="flex-1 bg-gray-50 dark:bg-gray-700/50 p-4 rounded-2xl text-center border border-gray-100 dark:border-gray-600 hover:shadow-md transition-all">
            <img
              src="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/mystic-water.png"
              alt="Smoothness"
              className="w-8 h-8 mx-auto mb-1 object-contain"
            />
        ...
        <h3 className="font-bold text-lg mb-4 text-gray-800 dark:text-white border-b border-gray-100 dark:border-gray-700 pb-2 flex items-center gap-2 transition-colors">
          <img
            src="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/sweet-heart.png"
            alt="Flavor"
        ...
        {activeFlavors.length > 0 ? (
          <div className="flex flex-wrap gap-2 mt-3">
            {activeFlavors.map((flavor) => (
              <span
                ...
                className="px-4 py-2 bg-red-50 dark:bg-red-500/10 text-red-600 dark:text-red-400 rounded-xl text-sm font-bold capitalize border border-red-100 dark:border-red-500/20 transition-colors"
              >
          ...
          <p className="text-gray-500 dark:text-gray-400 text-sm italic mt-3 transition-colors">
            This berry has no strong flavors.
          </p>
        )}
      </div>
    </div>
