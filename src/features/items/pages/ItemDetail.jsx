...
/**
 * ItemDetailSkeleton Component
 * Displays loading placeholder for item detail view
 */
 ...
 * Displays detailed information about a specific Pokémon item
 */
const ItemDetail = ({ name, onClose }) => {
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-xl overflow-hidden relative transition-colors duration-300">
      {/* Header section with amber theme for items */}
      ...
      <div className="pt-20 px-8 pb-8">
        ...
        <h3 className="font-bold text-lg mb-2 flex items-center gap-2 text-gray-800 dark:text-white border-b border-gray-100 dark:border-gray-700 pb-2 transition-colors">
          <img
            src="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/zinc.png"
            alt="Effect"
        ...
        {item.attributes && item.attributes.length > 0 && (
          <div className="mt-6">
            <h3 className="font-bold text-lg mb-3 flex items-center gap-2 text-gray-800 dark:text-white border-b border-gray-100 dark:border-gray-700 pb-2 transition-colors">
              <img
                src="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/destiny-knot.png"
                alt="Attributes"
                className="w-5 h-5 object-contain"
              />
              Item Attributes
            ...
            <div className="flex flex-wrap gap-2 mt-2">
              {item.attributes.map((attr) => (
                <span
                  key={attr.name}
                  className="px-3 py-1 bg-amber-50 dark:bg-amber-500/10 text-amber-600 dark:text-amber-400 rounded-lg text-xs font-bold capitalize border border-amber-100 dark:border-amber-500/20 transition-colors"
                >
                  {attr.name.replace(/-/g, " ")}
                </span>
              ))}
