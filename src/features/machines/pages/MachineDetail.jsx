...
const MachineDetail = ({ id, onClose }) => {
  ...
  if (isError || !machine) return <div className="p-10 text-center text-red-500 font-bold bg-white dark:bg-gray-800 rounded-3xl">Machine not found!</div>;

  return (
    <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-xl overflow-hidden relative transition-colors duration-300">
      {/* HEADER TEMA KUNING-ORANYE */}
      <div className="bg-orange-500 dark:bg-orange-900 relative text-white h-[180px] flex items-center justify-center transition-colors duration-500 rounded-t-3xl">
        <div className="absolute top-0 left-0 w-full p-6 flex justify-between items-start z-20">
          ...
          <span className="text-xs font-bold opacity-90 uppercase px-3 py-1 bg-white/20 rounded-full tracking-wider shadow-sm flex items-center gap-1.5">
            <img src="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-normal.png" alt="TM" className="w-4 h-4 object-contain" />
            TM / HM
          </span>
        </div>
      ...
      <div className="pt-16 px-8 pb-8">
        ...
        <div className="flex flex-col sm:flex-row justify-between gap-4">
          ...
          <div className="flex-1 bg-gray-50 dark:bg-gray-700/50 p-5 rounded-2xl text-center border border-gray-100 dark:border-gray-600 hover:shadow-md transition-all flex flex-col items-center">
            <img src="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/expert-belt.png" alt="Move" className="w-8 h-8 mb-2 object-contain" />
            <p className="text-xs text-gray-500 dark:text-gray-400 font-bold uppercase tracking-wider mb-1">Teaches Move</p>
          ...
          {/* Box Generasi Game */}
          <div className="flex-1 bg-gray-50 dark:bg-gray-700/50 p-5 rounded-2xl text-center border border-gray-100 dark:border-gray-600 hover:shadow-md transition-all flex flex-col items-center">
            <img src="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/vs-seeker.png" alt="Game" className="w-8 h-8 mb-2 object-contain" />
            <p className="text-xs text-gray-500 dark:text-gray-400 font-bold uppercase tracking-wider mb-1">Game Version</p>
