...
// Type color palette for move type badges
...
/**
 * MoveDetailSkeleton Component
 * Displays loading placeholder for move detail view
 */
 ...
 * Displays detailed information about a specific Pokémon move
 */
const MoveDetail = ({ name, onClose }) => {
  ...
  const description =
    move.flavor_text_entries?.find((e) => e.language.name === "en")?.flavor_text.replace(/\f/g, " ") ||
    "No description available.";
  const bgColor = MOVE_TYPE_COLORS[move.type.name] || "bg-gray-800";

  return (
    <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-xl overflow-hidden relative transition-colors duration-300">
      {/* Header section - displays move type with background color */}
      <div
        className={`${bgColor} relative text-white h-[200px] flex flex-col items-center justify-center transition-colors duration-500 rounded-t-3xl`}
      >
        ...
        <div className="z-10 text-center mt-4">
          <h1 className="text-3xl md:text-4xl font-bold capitalize tracking-wide drop-shadow-md px-4">
            {move.name.replace(/-/g, " ")}
          </h1>
      ...
      <div className="pt-8 px-8 pb-8">
        {/* Move stats boxes - power, accuracy, PP */}
        <div className="flex justify-between gap-4 mb-8">
          <div className="flex-1 bg-gray-50 dark:bg-gray-700/50 p-4 rounded-2xl text-center border border-gray-100 dark:border-gray-600 hover:shadow-md transition-all">
            <img
              src="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/muscle-band.png"
              alt="Power"
          ...
          <div className="flex-1 bg-gray-50 dark:bg-gray-700/50 p-4 rounded-2xl text-center border border-gray-100 dark:border-gray-600 hover:shadow-md transition-all">
            <img
              src="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/pp-up.png"
              alt="PP"
              className="w-8 h-8 mx-auto mb-1 object-contain"
            />
