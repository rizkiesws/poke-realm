 ...
 * Sliding volume control panel for game audio
 */
 ...
 * Interactive guessing game where players identify Pokémon from silhouettes
 */
const WhosThatPokemon = () => {
  ...
  // Game loading text rotation
  const loadingPhrases = useMemo(
    () => ["Searching in tall grass...", "Rustling leaves...", "A wild Pokémon appeared!"],
    [],
  );
  ...
  }, [isLoading, isFetching, loadingPhrases]);
  ...
  if (gameState === "menu") {
    return (
      <div
        className="w-full min-h-[85vh] rounded-3xl overflow-hidden relative border-8 border-gray-800 shadow-2xl flex flex-col items-center justify-center bg-cover bg-center"
        style={{
          backgroundImage:
            "url('https://camo.githubusercontent.com/f02eeb47242135dc8c8d8b6f37afb722dffc9ceafab31b5c2a7f5a5e39660c6f/68747470czovL2kuaW1ndXIuY29tL1FWeXpGZFAuZ2lm')",
        }}
      >
        ...
        <div className="relative z-10 flex flex-col items-center p-6 w-full max-w-4xl mt-10 md:mt-0">
          <div className="mb-10 drop-shadow-2xl text-center">
            <h1
              className="text-yellow-400 text-3xl md:text-5xl lg:text-6xl drop-shadow-[0_4px_0_#2563eb]"
              style={pixelFont}
            >
              Who's that
            </h1>
            <h1
              className="text-white text-4xl md:text-7xl lg:text-8xl mt-4 drop-shadow-[0_6px_0_#2563eb]"
              style={pixelFont}
            >
              Pokémon?
            </h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full px-2">
            ...
            <div className="flex flex-col items-center justify-between text-center bg-black/20 p-4 rounded-2xl backdrop-blur-sm border border-white/10 hover:bg-black/40 transition-colors">
              <div className="w-full">
                <button
                  onClick={() => startGame("starters")}
                  className="w-full bg-white border-[6px] border-gray-800 hover:scale-105 active:scale-95 transition-transform px-4 py-4 rounded-xl shadow-[6px_6px_0_rgba(0,0,0,0.5)]"
                >
                  <span className="text-gray-800 text-sm md:text-base" style={pixelFont}>
                    Starters mode
                  </span>
                </button>
                <p
                  className="text-white text-[9px] md:text-[10px] mt-4 mb-2 drop-shadow-md leading-relaxed font-bold max-w-[250px] mx-auto"
                  style={pixelFont}
                >
            ...
            <div className="flex flex-col items-center justify-between text-center bg-black/20 p-4 rounded-2xl backdrop-blur-sm border border-white/10 hover:bg-black/40 transition-colors">
              <div className="w-full">
                <button
                  onClick={() => startGame(selectedGen)}
                  className="w-full bg-white border-[6px] border-gray-800 hover:scale-105 active:scale-95 transition-transform px-4 py-3 rounded-xl shadow-[6px_6px_0_rgba(0,0,0,0.5)] mb-3"
                >
                  <span className="text-gray-800 text-sm md:text-base" style={pixelFont}>
                    Gen Mode
                  </span>
                ...
                <p
                  className="text-white text-[9px] md:text-[10px] mt-3 drop-shadow-md leading-relaxed font-bold max-w-[250px] mx-auto"
                  style={pixelFont}
                >
  ...
  return (
    <div
      className="w-full min-h-[85vh] rounded-3xl overflow-hidden relative border-8 border-gray-800 shadow-2xl flex flex-col bg-cover bg-center"
      style={{
        backgroundImage:
          "url('https://camo.githubusercontent.com/f02eeb47242135dc8c8d8b6f37afb722dffc9ceafab31b5c2a7f5a5e39660c6f/68747470czovL2kuaW1ndXIuY29tL1FWeXpGZFAuZ2lm')",
      }}
    >
      ...
      <div className="relative z-10 flex items-center h-16 md:h-20 p-4 md:p-6 bg-gray-900/80 border-b-4 border-gray-800">
        <button
          onClick={backToMenu}
          className="relative z-20 flex items-center gap-2 text-white hover:text-yellow-400 transition-colors"
          style={pixelFont}
        >
      ...
      <div className="relative z-10 flex-1 flex flex-col items-center justify-center p-6">
        {isLoading || isFetching ? (
          <div className="flex flex-col items-center h-full justify-center">
            ...
            />
            <p
              className="text-white text-[10px] md:text-xs text-center leading-loose tracking-widest drop-shadow-md h-8"
              style={pixelFont}
            >
              {loadingText}
            </p>
          ...
          <div className="w-full max-w-3xl flex flex-col items-center">
            ...
            <div className="min-h-[60px] text-center mb-6 w-full flex flex-col items-center justify-center">
              {isRevealed ? (
                <>
                  <p
                    className={`text-sm md:text-base mb-3 drop-shadow-md ${selectedOption === data.target.name ? "text-green-400" : "text-red-400"}`}
                    style={pixelFont}
                  >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 w-full px-2 md:px-8">
              {data.options.map((optionName) => {
                ...
                if (isRevealed) {
                  if (optionName === data.target.name)
                    btnClass =
                      "bg-green-500 text-white border-b-[6px] border-green-700 z-10 scale-105 shadow-[0_0_20px_rgba(34,197,94,0.5)]";
                  else if (optionName === selectedOption)
                    btnClass = "bg-red-500 text-white border-b-[6px] border-red-700";
